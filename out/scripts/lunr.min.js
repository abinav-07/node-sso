...
!(function () {
  ...
  (t.version = '0.7.1'),
    ...
    (t.tokenizer = function (e) {
      return arguments.length && e != null && void 0 != e
        ? Array.isArray(e)
          ? e.map(function (e) {
    ...
    (t.tokenizer.load = function (t) {
      const e = this.registeredFunctions[t];
    ...
    (t.Pipeline.load = function (e) {
      ...
      return (
        e.forEach(function (e) {
          const i = t.Pipeline.registeredFunctions[e];
    ...
    (t.SortedSet.prototype.union = function (t) {
      ...
      this.length >= t.length ? ((e = this), (n = t)) : ((e = t), (n = this)),
        (i = e.clone());
      for (let r = 0, o = n.toArray(); r < o.length; r++) i.add(o[r]);
      return i;
    }),
    ...
    (t.Index.prototype.field = function (t, e) {
      var e = e || {};
      const n = { name: t, boost: e.boost || 1 };
    ...
    (t.Index.prototype.tokenizer = function (e) {
      const n = e.label && e.label in t.tokenizer.registeredFunctions;
      return (
        n ||
          t.utils.warn(
    ...
    (t.Index.prototype.add = function (e, n) {
      const i = {};
      const r = new t.SortedSet();
      const o = e[this._ref];
      var n = void 0 === n ? !0 : n;
      this._fields.forEach(function (t) {
        const n = this.pipeline.run(this.tokenizerFn(e[t.name]));
        i[t.name] = n;
    ...
    (t.Index.prototype.remove = function (t, e) {
      ...
      if (this.documentStore.has(n)) {
        const i = this.documentStore.get(n);
    ...
    (t.Index.prototype.idf = function (t) {
      ...
      const n = this.tokenStore.count(t);
      let i = 1;
      return (
    ...
    (t.Index.prototype.search = function (e) {
      const n = this.pipeline.run(this.tokenizerFn(e));
      const i = new t.Vector();
      const r = [];
      const o = this._fields.reduce(function (t, e) {
        return t + e.boost;
      }, 0);
      const s = n.some(function (t) {
      ...
      n.forEach(function (e, n, s) {
        ...
        const h = this;
        const u = this.tokenStore.expand(e).reduce(function (n, r) {
          const o = h.corpusTokens.indexOf(r);
          const s = h.idf(r);
          let u = 1;
          const l = new t.SortedSet();
          if (r !== e) {
            const c = Math.max(3, r.length - e.length);
            u = 1 / Math.log(c);
          }
          o > -1 && i.insert(o, a * s * u);
          for (
            let f = h.tokenStore.get(r),
              d = Object.keys(f),
              p = d.length,
              v = 0;
            p > v;
    ...
    (t.Index.prototype.documentVector = function (e) {
      for (
        ...
        const a = this.tokenStore.get(s)[e].tf;
        const h = this.idf(s);
    ...
    (t.stemmer = (function () {
      ...
      const c = new RegExp(h);
      const f = new RegExp(a);
      const d = new RegExp(u);
      const p = /^(.+?)(ss|i)es$/;
      const v = /^(.+?)([^s])s$/;
      const g = /^(.+?)eed$/;
      const m = /^(.+?)(ed|ing)$/;
      ...
      const k = new RegExp(`^${r}${i}[^aeiouwxy]$`);
      const x = /^(.+?[^aeiou])y$/;
      const b =
      ...
      const z = /^(.+?)e$/;
      const O = /ll$/;
      const P = new RegExp(`^${r}${i}[^aeiouwxy]$`);
      const T = function (n) {
        let i;
        let r;
        let o;
    ...
    (t.TokenStore.prototype.has = function (t) {
      if (!t) return !1;
      for (let e = this.root, n = 0; n < t.length; n++) {
