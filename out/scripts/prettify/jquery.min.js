...
(function (e, undefined) {
  let t;
  let n;
  const r = typeof undefined;
  const i = e.location;
  const o = e.document;
  const s = o.documentElement;
  const a = e.jQuery;
  const u = e.$;
  const l = {};
  const c = [];
  ...
  const g = c.indexOf;
  const m = l.toString;
  const y = l.hasOwnProperty;
  const v = f.trim;
  var x = function (e, n) {
    return new x.fn.init(e, n, t);
  };
  const b = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source;
  const w = /\S+/g;
  const T = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/;
  const C = /^<(\w+)\s*\/?>(?:<\/\1>|)$/;
  const k = /^-ms-/;
  ...
  (x.fn = x.prototype =
      ...
      function () {
        ...
        for (
          typeof s === 'boolean' &&
            ...
            typeof s === 'object' || x.isFunction(s) || (s = {}),
            u === a && ((s = this), --a);
          u > a;
          a++
        )
    ...
    x.extend({
      ...
      isPlainObject(e) {
        if (x.type(e) !== 'object' || e.nodeType || x.isWindow(e)) return !1;
        try {
          if (
            e.constructor &&
      ...
      merge(e, t) {
        ...
        let r = e.length;
        let i = 0;
        if (typeof n === 'number') for (; n > i; i++) e[r++] = t[i];
      ...
      map(e, t, n) {
        ...
        else for (i in e) (r = t(e[i], i, n)), r != null && (a[a.length] = r);
        return p.apply([], a);
      },
      guid: 1,
      proxy(e, t) {
  ...
  (t = x(o)),
    (function (e, undefined) {
      ...
      const R = '[\\x20\\t\\r\\n\\f]';
      const M = '(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+';
      const W = M.replace('w', 'w#');
      const $ = `\\[${R}*(${M})${R}*(?:([*^$|!~]?=)${R}*(?:(['"])((?:\\\\.|[^\\\\])*?)\\3|(${W})|)|)${R}*\\]`;
      const B = `:(${M})(?:\\(((['"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|${$.replace(
        3,
        8
      )})*)|.*)\\)|)`;
      const I = RegExp(`^${R}+|((?:^|[^\\\\])(?:\\\\.)*)${R}+$`, 'g');
      const z = RegExp(`^${R}*,${R}*`);
      const _ = RegExp(`^${R}*([>+~]|${R})${R}*`);
      const X = RegExp(`${R}*[+~]`);
      const U = RegExp(`=${R}*([^\\]'"]*)${R}*\\]`, 'g');
      const Y = RegExp(B);
      const V = RegExp(`^${W}$`);
      const G = {
        ID: RegExp(`^#(${M})`),
      ...
      const J = /^[^{]+\{\s*\[native \w/;
      const Q = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/;
      const K = /^(?:input|select|textarea|button)$/i;
      const Z = /^h\d$/i;
      const et = /'|\\/g;
      const tt = /\\([\da-fA-F]{1,6}[\x20\t\r\n\f]?|.)/g;
      ...
      (o = ut.isXML =
        ...
        (l = ut.setDocument =
          function (e) {
            ...
            return t !== c && t.nodeType === 9 && t.documentElement
              ? ((c = t),
                (f = t.documentElement),
                (p = !o(t)),
        ...
        (ut.attr = function (e, t) {
          (e.ownerDocument || e) !== c && l(e);
          const n = r.attrHandle[t.toLowerCase()];
          let i = n && n(e, t, !p);
          return i === undefined
            ? b.attributes || !p
              ? e.getAttribute(t)
      ...
      function lt(e, t) {
        let n = t && e;
        const r = n && (~t.sourceIndex || D) - (~e.sourceIndex || D);
        if (r) return r;
      ...
      function ft(e, t, n) {
        ...
        return n
          ? undefined
          : (r = e.getAttribute(t, t.toLowerCase() === 'type' ? 1 : 2));
      }
      function pt(e) {
        return function (t) {
        ...
        (r = ut.selectors =
          {
            ...
            filter: {
              TAG(e) {
                const t = e.replace(tt, nt).toLowerCase();
                return e === '*'
                  ? function () {
                      return !0;
                    }
      ...
      function yt(e, t, r) {
        const i = t.dir;
        const o = r && i === 'parentNode';
        const s = T++;
        return t.first
          ? function (t, n, r) {
              while ((t = t[i])) if (t.nodeType === 1 || o) return e(t, n, r);
            }
          : function (t, r, a) {
              let u;
              let l;
              ...
              if (a) {
                while ((t = t[i]))
                  if ((t.nodeType === 1 || o) && e(t, r, a)) return !0;
              } else
                while ((t = t[i]))
                  if (t.nodeType === 1 || o)
      ...
      function bt(e, t, n, r, i, o) {
        return (
          ...
          st(function (o, s, a, u) {
            ...
            const h = [];
            const d = s.length;
            const g = o || Ct(t || '*', a.nodeType ? [a] : a, []);
            const m = !e || (!o && t) ? g : xt(g, p, e, a, u);
            let y = n ? (i || (o ? e : d || r) ? [] : s) : m;
            if ((n && n(m, y, a, u), r)) {
      ...
      function wt(e) {
        ...
        let i;
        const o = e.length;
        const s = r.relative[e[0].type];
        const u = s || r.relative[' '];
        let l = s ? 1 : 0;
        const c = yt(
          function (e) {
            return e === t;
      ...
      function Tt(e, t) {
        ...
        const u = function (u, l, f, p, h) {
          ...
          const T = h != null;
          const C = a;
          const k = u || (s && r.find.TAG('*', (h && l.parentNode) || l));
          const N = (w += C == null ? 1 : Math.random() || 0.1);
          for (T && ((a = l !== c && l), (n = i)); (d = k[x]) != null; x++) {
            if (s && d) {
              g = 0;
              while ((m = e[g++]))
                if (m(d, l, f)) {
      ...
      (Nt.prototype = r.filters = r.pseudos),
        ...
        at(function (e) {
          if (
            ...
            const t = 'type|href|height|width'.split('|');
            let n = t.length;
  ...
  (x.Callbacks = function (e) {
    e = typeof e === 'string' ? D[e] || A(e) : x.extend({}, e);
    let t;
    let n;
    let r;
    let i;
    ...
    x.extend({
            ...
            return x
              .Deferred(function (n) {
                x.each(t, function (t, o) {
                  const s = o[0];
                  const a = x.isFunction(e[t]) && e[t];
                  i[o[1]](function () {
                    const e = a && a.apply(this, arguments);
      ...
      when(e) {
        let t = 0;
        const n = d.call(arguments);
        const r = n.length;
        let i = r !== 1 || (e && x.isFunction(e.promise)) ? r : 0;
        const o = i === 1 ? e : x.Deferred();
    ...
    (x.support = (function (t) {
      let n = o.createElement('input');
      const r = o.createDocumentFragment();
      const i = o.createElement('div');
      const s = o.createElement('select');
      const a = s.appendChild(o.createElement('option'));
      return n.type
        ? ((n.type = 'checkbox'),
          (t.checkOn = n.value !== ''),
          ...
          (t.clearCloneStyle = i.style.backgroundClip === 'content-box'),
          x(function () {
            let n;
            let r;
            const s =
            ...
            a &&
              ...
              x.swap(a, a.style.zoom != null ? { zoom: 1 } : {}, function () {
                t.boxSizing = i.offsetWidth === 4;
              }),
              e.getComputedStyle &&
                ((t.pixelPosition =
                  (e.getComputedStyle(i, null) || {}).top !== '1%'),
                (t.boxSizingReliable =
    ...
    x.fn.extend({
      data(e, t) {
        ...
        if (e === undefined) {
          if (
            this.length &&
            ((s = L.get(i)), i.nodeType === 1 && !q.get(i, 'hasDataAttrs'))
          ) {
      ...
      queue(e, t) {
        ...
        return (
          ...
          n > arguments.length
            ...
            ? this
            : this.each(function () {
                const n = x.queue(this, e, t);
                x._queueHooks(this, e),
                  e === 'fx' && n[0] !== 'inprogress' && x.dequeue(this, e);
              })
        );
      },
      dequeue(e) {
  ...
  const W = /[\t\r\n]/g;
  const $ = /\r/g;
  const B = /^(?:input|select|textarea|button)$/i;
  x.fn.extend({
    attr(e, t) {
    ...
    removeClass(e) {
      ...
      let s = 0;
      const a = this.length;
      const u = arguments.length === 0 || (typeof e === 'string' && e);
      if (x.isFunction(e))
        return this.each(function (t) {
    ...
    toggleClass(e, t) {
      ...
      return x.isFunction(e)
        ...
        : this.each(function () {
            ...
            } else (n === r || n === 'boolean') && (this.className && q.set(this, '__className__', this.className), (this.className = this.className || e === !1 ? '' : q.get(this, '__className__') || ''));
          });
    },
    hasClass(e) {
      const t = ` ${e} `;
        ...
        if (i)
          return (
            ...
            t && 'get' in t && (n = t.get(i, 'value')) !== undefined
              ? n
              : ((n = i.value),
                typeof n === 'string' ? n.replace($, '') : n == null ? '' : n)
          );
      }
    },
  }),
      ...
      valHooks: {
        ...
        select: {
          get(e) {
            ...
            const o = e.type === 'select-one' || i < 0;
            const s = o ? null : [];
            const a = o ? i + 1 : r.length;
            let u = i < 0 ? a : o ? i : 0;
            for (; a > u; u++)
              if (
                ((n = r[u]),
        ...
        if (e && s !== 3 && s !== 8 && s !== 2)
          return typeof e.getAttribute === r
            ...
            : ((s === 1 && x.isXMLDoc(e)) ||
              ...
              n === undefined
                ? i && 'get' in i && (o = i.get(e, t)) !== null
                  ? o
                  : ((o = x.find.attr(e, t)), o == null ? undefined : o)
                : n !== null
    ...
    x.each(x.expr.match.boolean.source.match(/\w+/g), function (e, t) {
      const n = x.expr.attrHandle[t] || x.find.attr;
      x.expr.attrHandle[t] = function (e, t, r) {
        const i = x.expr.attrHandle[t];
        const o = r
          ? undefined
  ...
  const I = /^key/;
  const z = /^(?:mouse|contextmenu)|click/;
  const _ = /^(?:focusinfocus|focusoutblur)$/;
  const X = /^([^.]*)(?:\.(.+)|)$/;
  function U() {
    return !0;
  }
  ...
  (x.event = {
    ...
    trigger(t, n, r, i) {
      ...
      let p;
      const h = [r || o];
      let d = y.call(t, 'type') ? t.type : t;
      let g = y.call(t, 'namespace') ? t.namespace.split('.') : [];
      if (
        ((a = u = r = r || o),
        r.nodeType !== 3 &&
          r.nodeType !== 8 &&
          ...
          (c = d.indexOf(':') < 0 && `on${d}`),
          (t = t[x.expando] ? t : new x.Event(d, typeof t === 'object' && t)),
          (t.isTrigger = i ? 2 : 3),
          (t.namespace = g.join('.')),
    ...
    dispatch(e) {
      ...
      let o;
      let s = [];
      const a = d.call(arguments);
      const u = (q.get(this, 'events') || {})[e.type] || [];
      const l = x.event.special[e.type] || {};
      if (
        ((a[0] = e),
    ...
    x.fn.extend({
      ...
      off(e, t, n) {
        ...
        return (
          (t === !1 || typeof t === 'function') && ((n = t), (t = undefined)),
          n === !1 && (n = Y),
          this.each(function () {
  ...
  const G = /^.[^:#\[\.,]*$/;
  const J = x.expr.match.needsContext;
  ...
  x.fn.extend({
    ...
    closest(e, t) {
      ...
      const o = [];
      const s =
        J.test(e) || typeof e !== 'string' ? x(e, t || this.context) : 0;
      for (; i > r; r++)
        for (n = this[r]; n && n !== t; n = n.parentNode)
          if (
            ...
            (s
              ? s.index(n) > -1
              : n.nodeType === 1 && x.find.matchesSelector(n, e))
          ) {
            n = o.push(n);
            break;
          }
  ...
  x.each(
    ...
    function (e, t) {
      x.fn[e] = function (n, r) {
        ...
        return (
          e.slice(-5) !== 'Until' && (r = n),
          r && typeof r === 'string' && (i = x.filter(r, i)),
          this.length > 1 && (Q[e] || x.unique(i), e[0] === 'p' && i.reverse()),
          this.pushStack(i)
        );
      };
    }
  ...
  const tt = /<([\w:]+)/;
  const nt = /<|&#?\w+;/;
  const rt = /<(?:script|style|link)/i;
  const it = /^(?:checkbox|radio)$/i;
  const ot = /checked\s*(?:[^=]|=\s*.checked.)/i;
  const st = /^$|\/(?:java|ecma)script/i;
  const at = /^true\/(.*)/;
  const ut = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
  const lt = {
  ...
  (lt.optgroup = lt.option),
    ...
    x.fn.extend({
      ...
      remove(e, t) {
        ...
        let i = 0;
        for (; (n = r[i]) != null; i++)
          t || n.nodeType !== 1 || x.cleanData(gt(n)),
            n.parentNode &&
      ...
      domManip(e, t, n) {
        ...
        const h = c - 1;
        const d = e[0];
        const g = x.isFunction(d);
        if (
          g ||
          (!(c <= 1 || typeof d !== 'string' || x.support.checkClone) &&
            ot.test(d))
        )
    ...
    x.extend({
      clone(e, t, n) {
        ...
        const u = x.contains(e.ownerDocument, e);
        if (
          !(
      ...
      buildFragment(e, t, n, r) {
        ...
        let c = 0;
        const f = e.length;
        const p = t.createDocumentFragment();
        const h = [];
        for (; f > c; c++)
          if (((i = e[c]), i || i === 0))
            if (x.type(i) === 'object') x.merge(h, i.nodeType ? [i] : i);
            else if (nt.test(i)) {
  ...
  function ct(e, t) {
    return x.nodeName(e, 'table') &&
      x.nodeName(t.nodeType === 1 ? t : t.firstChild, 'tr')
  ...
  const bt = /^margin/;
  const wt = RegExp(`^(${b})(.*)$`, 'i');
  const Tt = RegExp(`^(${b})(?!px)[a-z%]+$`, 'i');
  const Ct = RegExp(`^([+-])=(${b})`, 'i');
  const kt = { BODY: 'block' };
  const Nt = { position: 'absolute', visibility: 'hidden', display: 'block' };
  const Et = { letterSpacing: 0, fontWeight: 400 };
  const St = ['Top', 'Right', 'Bottom', 'Left'];
  const jt = ['Webkit', 'O', 'Moz', 'ms'];
  function Dt(e, t) {
    if (t in e) return t;
  ...
  function At(e, t) {
    return (
      (e = t || e),
      x.css(e, 'display') === 'none' || !x.contains(e.ownerDocument, e)
    );
  }
  function Lt(t) {
  ...
  x.fn.extend({
    ...
    (yt = function (e, t, n) {
      ...
      let o;
      const s = n || Lt(e);
      let a = s ? s.getPropertyValue(t) || s[t] : undefined;
      const u = e.style;
      return (
        s &&
  ...
  function Ot(e, t, n, r, i) {
    let o = n === (r ? 'border' : 'content') ? 4 : t === 'width' ? 1 : 0;
    let s = 0;
    for (; o < 4; o += 2)
      n === 'margin' && (s += x.css(e, n + St[o], !0, i)),
        r
          ? (n === 'content' && (s -= x.css(e, `padding${St[o]}`, !0, i)),
            n !== 'margin' && (s -= x.css(e, `border${St[o]}Width`, !0, i)))
          : ((s += x.css(e, `padding${St[o]}`, !0, i)),
            n !== 'padding' && (s += x.css(e, `border${St[o]}Width`, !0, i)));
    return s;
  }
  function Ft(e, t, n) {
    let r = !0;
    ...
    const o = Lt(e);
    const s =
      x.support.boxSizing && x.css(e, 'boxSizing', !1, o) === 'border-box';
    if (i <= 0 || i == null) {
      if (
        ((i = yt(e, t, o)),
  ...
  x.each(['height', 'width'], function (e, t) {
    x.cssHooks[t] = {
      get(e, n, r) {
        return n
          ? e.offsetWidth === 0 && xt.test(x.css(e, 'display'))
        ...
        return Ht(
          ...
          r
            ? Ot(
                ...
                r,
                x.support.boxSizing &&
                  x.css(e, 'boxSizing', !1, i) === 'border-box',
                i
              )
            : 0
        );
    ...
    x.each({ margin: '', padding: '', border: 'Width' }, function (e, t) {
      (x.cssHooks[e + t] = {
        expand(n) {
          let r = 0;
          const i = {};
          const o = typeof n === 'string' ? n.split(' ') : [n];
          for (; r < 4; r++) i[e + St[r] + t] = o[r] || o[r - 2] || o[0];
          return i;
        },
      }),
  ...
  const It = /^(?:input|select|textarea|keygen)/i;
  x.fn.extend({
    serialize() {
  ...
  function zt(e, t, n, r) {
    ...
    else if (n || x.type(t) !== 'object') r(e, t);
  ...
  const Gt = /([?&])_=[^&]*/;
  const Jt = /^(.*?):[ \t]*([^\r\n]*)$/gm;
  const Qt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/;
  const Kt = /^(?:GET|HEAD)$/;
  const Zt = /^\/\//;
  const en = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/;
  const tn = x.fn.load;
  ...
  function ln(e, t) {
    let n;
    let r;
    const i = x.ajaxSettings.flatOptions || {};
    for (n in t) t[n] !== undefined && ((i[n] ? e : r || (r = {}))[n] = t[n]);
    return r && x.extend(!0, e, r), e;
  }
  (x.fn.load = function (e, t, n) {
    if (typeof e !== 'string' && tn) return tn.apply(this, arguments);
    let r;
    let i;
    let o;
    const s = this;
    ...
    x.extend({
      ...
      ajax(e, t) {
        ...
        let u;
        let l;
        const c = x.ajaxSetup({}, t);
        const f = c.context || c;
        const p = c.context && (f.nodeType || f.jquery) ? x(f) : x.event;
        const h = x.Deferred();
        const d = x.Callbacks('once memory');
        let g = c.statusCode || {};
        const m = {};
        const y = {};
        let v = 0;
        ...
        if (
          ...
          return T;
        (u = c.global),
          u && x.active++ === 0 && x.event.trigger('ajaxStart'),
  ...
  let dn = x.ajaxSettings.xhr();
  const gn = { 0: 200, 1223: 204 };
  let mn = 0;
  let yn = {};
  e.ActiveXObject &&
    x(e).on('unload', function () {
      for (const e in yn) yn[e]();
      yn = undefined;
    }),
  ...
  let vn;
  let xn;
  const bn = /^(?:toggle|show|hide)$/;
  const wn = RegExp(`^(?:([+-])=|)(${b})([a-z%]*)$`, 'i');
  const Tn = /queueHooks$/;
  const Cn = [Dn];
  const kn = {
    '*': [
  ...
  function Sn(e, t, n) {
    ...
    let o = 0;
    const s = Cn.length;
    const a = x.Deferred().always(function () {
      delete u.elem;
    });
    var u = function () {
      if (i) return !1;
      const t = vn || Nn();
      const n = Math.max(0, l.startTime + l.duration - t);
      const r = n / l.duration || 0;
      const o = 1 - r;
      let s = 0;
      const u = l.tweens.length;
      for (; u > s; s++) l.tweens[s].run(o);
      return (
        a.notifyWith(e, [l, o, n]), o < 1 && u ? n : (a.resolveWith(e, [l]), !1)
      );
    };
    var l = a.promise({
      elem: e,
  ...
  function Dn(e, t, n) {
    ...
    for (r in t)
      if (((o = t[r]), bn.exec(o))) {
        if (
          (delete t[r], (u = u || o === 'toggle'), o === (m ? 'hide' : 'show'))
        ) {
          if (o !== 'show' || a === undefined || a[r] === undefined) continue;
          m = !0;
        }
        g.push(r);
      }
  ...
  (x.Tween = An),
    (An.prototype = {
      ...
      cur() {
        const e = An.propHooks[this.prop];
        return e && e.get ? e.get(this) : An.propHooks._default.get(this);
      },
      run(e) {
        let t;
        const n = An.propHooks[this.prop];
        return (
          (this.pos = t =
      ...
      _default: {
        get(e) {
          ...
          return e.elem[e.prop] == null ||
            ...
            ? ((t = x.css(e.elem, e.prop, '')), t && t !== 'auto' ? t : 0)
            : e.elem[e.prop];
        },
        set(e) {
          x.fx.step[e.prop]
            ? x.fx.step[e.prop](e)
            : e.elem.style &&
              (e.elem.style[x.cssProps[e.prop]] != null || x.cssHooks[e.prop])
    ...
    (x.offset = {
      setOffset(e, t, n) {
        ...
        c === 'static' && (e.style.position = 'relative'),
          ...
          t.left != null && (p.left = t.left - a.left + i),
